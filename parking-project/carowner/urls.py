...
from carowner.views import AddCredit, AddRate, CarCreate, CarDelete, CarList, CarUpdate, CarOwnerCreate, CarOwnerDetail, \
    ...
    MostPopularParkings, AddParkingMonitor,ReservationUpdate,CancellationCount,PassedReservationList
...
urlpatterns = [
    ...
    #Reservation update
    path('update_reserve/',ReservationUpdate.as_view()),
    ...
    #All reserves
    path('allreserve/', PassedReservationList.as_view()),
    #Cancellation count
